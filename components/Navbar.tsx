        ...
        >
          ...
          >
            <span
              ...
              style={{ width: '34px', height: '34px', background: '#fff' }}
            >
              <Image src="/assets/logo.jpg" alt="MGM Hospitals logo" fill sizes="34px" style={{ objectFit: 'cover' }} priority />
            </span>
              ...
              >
                ...
                >
                  ...
                  {dropdown && (
                    <ChevronDown
                      size={14}
                      style={{ transition: 'transform 0.2s ease', transform: servicesOpen ? 'rotate(180deg)' : 'rotate(0deg)' }}
                      aria-hidden
                    />
                  )}
                </Link>
            ...
            dropdown ? (
              <div key={href}>
                ...
                >
                  ...
                  <ChevronDown
                    size={14}
                    style={{ color: '#f7b93b', transition: 'transform 0.2s ease', transform: mobileServicesOpen ? 'rotate(180deg)' : 'rotate(0deg)' }}
                    aria-hidden
                  />
                </button>
                {mobileServicesOpen && (
